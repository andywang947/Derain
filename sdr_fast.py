...
parser.add_argument("--input_path", type=str, default="./dataset/" + dataset + "/input/", help='input path')
parser.add_argument("--ldgp_path", type=str, default="./dataset/" + dataset + "/ldgp/", help='ldgp path')
parser.add_argument("--save_path", type=str, default="./dataset/" + dataset + "/sdr/" , help='sdr save path')
parser.add_argument("--fuse_save_path", type=str, default="./dataset/" + dataset + "/sdr(fuse)/" , help='fuse sdr save path')
...
for image_name in rainy_folder:
   ...
   count = 0
   valid_indices = np.argwhere(ldgp_image > ldgp_intensity_threshold)
   total_iterations = len(valid_indices)
